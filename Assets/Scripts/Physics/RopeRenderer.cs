...
public class RopeRenderer : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Draw the rope visually by connecting the anchor and actual bucket attachment point.
        // The parent BucketRig position already reflects stretch/contraction from the custom pendulum.
        _lineRenderer.SetPosition(0, anchorTransform.position);
        _lineRenderer.SetPosition(1, ropeEnd.position);
